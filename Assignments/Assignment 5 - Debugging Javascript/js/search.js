...
(function(){
	...
	// Correction - Missing {
	// Correction - Fixed spelling 'validate'
	var validate = function(query){
		...
		// Correction - Fixed spelling of charAt
	...
	// Correction - missing opening {
	var search = function(query){

		// Correction - Changed join to split
		...
		for(var i=0, j=db.length; i<j; i++) {
			...
			// Correction - Fixed spelling of toLowerCase
	...
	var showMatches = function(results){
		...
		for(var i=0, j=results.length; i<j; i++){
			...
			// Correction - Spelling of 'subString'
